      ...
      <div className="relative w-full">
        ...
        <div className="relative w-full px-2 sm:px-4 lg:px-8 text-white">
          <div className="flex h-16 items-center justify-between w-full text-white">
            ...
            >
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-r from-gray-100 to-gray-100 flex items-center justify-center text-black font-bold text-base sm:text-lg">
                MC
              </div>
