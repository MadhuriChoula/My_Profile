        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 py-8 sm:py-12 w-full">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs sm:text-sm text-gray-400">
              Full Stack Engineer based in Hyderabad.
            </p>
          </div>
          ...
          <div className="space-y-4 mt-8 sm:mt-0">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a
                  href="mailto:madhurichoula12@gmail.com"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Email Madhuri Choula"
                >
                  <Mail className="w-4 h-4" aria-hidden="true" />
                  madhurichoula12@gmail.com
                </a>
              </li>
              <li>
                <a
                  href="tel:+919381933031"
                  className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"
                  aria-label="Call Madhuri Choula"
                >
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://linkedin.com/in/madhuri-choula-535218329/"
                target="_blank"
