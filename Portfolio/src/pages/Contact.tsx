...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xgonkbgk", {
        method: "POST",
        headers: {
  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "madhurichoula12@gmail.com",
      link: "mailto:madhurichoula12@gmail.com",
    },
    {
      icon: <Phone className="w-5 h-5" />,
      label: "Phone",
      value: "+91 9381933031",
      link: "tel:+919381933031",
    },
    {
  ...
  const socialLinks = [
    {
      ...
      label: "LinkedIn",
      link: "https://linkedin.com/in/madhuri-choula-535218329/",
    },
    {
      icon: <MessageCircle className="w-5 h-5" />,
      label: "WhatsApp",
      link: "https://wa.me/919381933031",
    },
  ];
