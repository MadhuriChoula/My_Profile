  ...
  const educationData = [
    {
      ...
      coursework: ["JavaScript", "Java", "C", "DBMS", "OS", "Networking"],
      description:
        "Awarded Gold Medal for Merit. Graduated with distinction, ranked top 2% in Programming in Core Java (NPTEL). Developed strong foundation in software engineering, programming, and system design. Certificate of Merit issued by Osmania University.",
    },
    {
